...
it("renders without crashing", function () {
    ...
    react_dom_1.default.render(react_1.default.createElement(Headers_1.default, null), div);
...
it("renders empty with empty params", function () {
    var div = document.createElement("div");
    react_dom_1.default.render(react_1.default.createElement(Headers_1.default, { headers: [] }), div);
    expect(div.innerHTML).toBe("");
    react_dom_1.default.unmountComponentAtNode(div);
});
it("renders params", function () {
    ...
    react_dom_1.default.render(react_1.default.createElement(Headers_1.default, { headers: params, disableTransitionProps: true }), div);
