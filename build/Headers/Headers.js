...
var Headers = /** @class */ (function (_super) {
    ...
    Headers.prototype.render = function () {
        var _this = this;
        var _a = this.props, headers = _a.headers, classes = _a.classes, uiSchema = _a.uiSchema;
        ...
        return (react_1.default.createElement(Table_1.default, { className: classes.table },
            ...
            react_1.default.createElement(TableBody_1.default, null,
                react_1.default.createElement(TableRow_1.default, null,
                    react_1.default.createElement(TableCell_1.default, { colSpan: 6 }, headers.map(function (row) {
...
exports.default = styles_1.withStyles(styles)(Headers);
